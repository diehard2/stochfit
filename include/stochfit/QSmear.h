...
inline void BuildArrays(double lambda, double qspread, std::span<const double> sinthetai, std::span<const double> qerror,
                        std::span<double> qspreadsinthetai, std::span<double> qspreadsinsquaredthetai)
{
