...
//
// All data crosses the boundary as FlatBuffers byte buffers (schema:
// schema/stochfit.fbs). Input functions:  (const uint8_t* buf, int len) Output
// functions: (uint8_t* outBuf, int maxLen) → int bytes written
//
