...
static const double qrange[] = {0.020, 0.026, 0.032, 0.038, 0.044, 0.050, 0.056, 0.062, 0.068, 0.074, 0.080, 0.086, 0.092, 0.098, 0.104,
                                0.110, 0.116, 0.122, 0.128, 0.134, 0.140, 0.146, 0.152, 0.158, 0.164, 0.170, 0.176, 0.182, 0.188, 0.194,
                                0.200, 0.206, 0.212, 0.218, 0.224, 0.230, 0.236, 0.242, 0.248, 0.254, 0.260, 0.266, 0.272, 0.278, 0.284,
                                0.290, 0.296, 0.302, 0.308, 0.314, 0.320, 0.326, 0.332, 0.338, 0.344, 0.350, 0.356, 0.362, 0.368, 0.374,
                                0.380, 0.386, 0.392, 0.398, 0.404, 0.410, 0.416, 0.422, 0.428, 0.434, 0.440, 0.446, 0.452, 0.458, 0.464,
                                0.470, 0.476, 0.482, 0.488, 0.494, 0.500, 0.506, 0.512, 0.518, 0.524, 0.530, 0.536, 0.542, 0.548, 0.554,
...
static void MakeBoxReflSettings(ReflSettings& s, double wavelength, const std::vector<double>& Q)
{
    s = {};
...
TEST(Reflectivity, BoxModelSingleFilm)
{
    ...
    // -- Q = 0.016 (below Qc_Si ≈ 0.0217): total reflection ----------------------
    {
        ...
        std::vector<std::complex<double>> rho = {{0.0, 0.0}, {filmSLD * rho2, 0.0}, {SubSLD * rho2, 0.0}};
        std::vector<std::complex<double>> lm = {{0.0, 0.0}, {0.0, -2.0 * d}, {0.0, 0.0}};
        LayerStack ls{};
        ls.rho = rho;
        ls.length_mult = lm;
        ls.sup_offset = 0;
